...
class AdminEditServiceComponent extends Component
{
    ...
    public function updateService()
    {
        ...
        if($this->newthumbnail)
        {
            ...
            $iamgeName = Carbon::now()->timestamp . '.' . $this->newthumbnail->extension();
            $this->newthumbnail->storeAs('services/thumbnails',$iamgeName);
            $service->thumbnail = $iamgeName;
        }
        ...
        if($this->newimage)
        {
            ...
            $iamgeName2 = Carbon::now()->timestamp . '.' . $this->newimage->extension();
            $this->newimage->storeAs('services',$iamgeName2);
            $service->image = $iamgeName2;
        }


        $service->save();
        session()->flash('message','Services has been updated successfully!');
    }

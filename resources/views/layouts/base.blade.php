                ...
                <ul class="collapse">
                    ...
                    <li> <a href="#">Home Cleaning</a>
                        <ul class="drop-down one-column hover-fade">
                            ...
                            <li><a href="service-details/underground-sump-cleaning.html">Underground Sump Cleaning</a></li>
                    ...
                    @if (Route::has('login'))
                        @auth
                            ...
                            @else
                            <li class="login-form"> <a href="#" title="Register">My Account (Customar)</a>
                                <ul class="drop-down one-column hover-fade">
                                    <li><a href="{{route('customar.dashboard')}}">Dashboard</a></li>
                                    <li><a href="{{route('logout')}}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a></li>
                                </ul>
                            </li>
                            @endif

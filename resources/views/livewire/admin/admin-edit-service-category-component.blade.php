                                ...
                                <div class="panel-body">
                                    ...
                                    <form class="form-horizontal" wire:submit.prevent="updateServiceCategory">
                                        ...
                                        <div class="form-group">
                                            <label for="name" class="control-lable col-sm-3">Category Name: </label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="slug" class="control-lable col-sm-3">Category Slug: </label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="slug" class="control-lable col-sm-3">Category Image: </label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="featured" class="control-lable col-sm-3">Featured: </label>
                                            <div class="col-sm-9">

                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <form class="form-horizontal" wire:submit.prevent="updateProfile">
                                                <div class="form-group">
                                                    <label for="newimage" class="control-lable col-md-3">Profile Image: </label>
                                                    <div class="col-md-9">
                                                ...
                                                <div class="form-group">
                                                    <label for="about" class="control-lable col-md-3">About: </label>
                                                    <div class="col-md-9">
                                                        <textarea class="form-control" name="about" wire:model="about"></textarea>
                                                    </div>
                                                </div>
                                                    <div class="form-group">
                                                        <label for="city" class="control-lable col-md-3">City: </label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="city" wire:model="city"/>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="service_category_id" class="control-lable col-md-3">Service Category: </label>
                                                    <div class="col-md-9">
                                                ...
                                                <div class="form-group">
                                                    <label for="service_locations" class="control-lable col-md-3">Service Locations Zipcode/Pincode: </label>
                                                    <div class="col-md-9">
